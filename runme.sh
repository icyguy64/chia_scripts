...
sudo mount /dev/nvme2n1 /temp3/
sudo mount /dev/nvme3n1 /temp4/
sudo mount /dev/nvme4n1 /temp5/
sudo mount /dev/nvme5n1 /temp6/
sudo mount /dev/nvme6n1 /temp7/
sudo mount /dev/nvme7n1 /temp8/
sudo mount /dev/nvme8n1 /plots/
